# Sensirion Raspberry Pi I2C SF06-LF Driver

This document explains how to set up a sensor of the SF06-LF sensor family to run on a Raspberry Pi
...
Your sensor has the 4 different connectors: SDA, VDD, GND, SCL.
